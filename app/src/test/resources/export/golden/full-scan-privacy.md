...
Flags: crossChannelMismatch=true, dualStackObserved=true, probeTargetDivergence=true, probeTargetDirectDivergence=true, geoCountryMismatch=true, sameAsnAcrossChannels=true, channelConflict=DIRECT, VPN, foreignIps=203.0.*.*, needsReview=true

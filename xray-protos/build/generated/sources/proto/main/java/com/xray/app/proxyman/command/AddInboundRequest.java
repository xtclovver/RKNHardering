...
public  final class AddInboundRequest extends
    com.google.protobuf.GeneratedMessageLite<
        AddInboundRequest, AddInboundRequest.Builder> implements
   ...
   * <code>.xray.core.InboundHandlerConfig inbound = 1;</code>
   */
  private void setInbound(com.xray.core.InboundHandlerConfig value) {
    value.getClass();
  inbound_ = value;
  ...
  private void mergeInbound(com.xray.core.InboundHandlerConfig value) {
    value.getClass();
  if (inbound_ != null &&
   ...
   * <code>.xray.core.InboundHandlerConfig inbound = 1;</code>
   */
  private void clearInbound() {  inbound_ = null;
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.xray.app.proxyman.command.AddInboundRequest, Builder> implements
    ...
    public Builder setInbound(
      ...
      copyOnWrite();
      instance.setInbound(builderForValue.build());
      return this;
    }
    /**
     * <code>.xray.core.InboundHandlerConfig inbound = 1;</code>
    ...
    public Builder mergeInbound(com.xray.core.InboundHandlerConfig value) {
      copyOnWrite();
      instance.mergeInbound(value);
      return this;
    }
    /**
     * <code>.xray.core.InboundHandlerConfig inbound = 1;</code>
     */
    public Builder clearInbound() {  copyOnWrite();
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.xray.app.proxyman.command.AddInboundRequest();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.xray.app.proxyman.command.AddInboundRequest> parser = PARSER;
        if (parser == null) {
          synchronized (com.xray.app.proxyman.command.AddInboundRequest.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.xray.app.proxyman.command.AddInboundRequest>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  static {
    AddInboundRequest defaultInstance = new AddInboundRequest();
    // New instances are implicitly immutable so no need to make
    // immutable.
    DEFAULT_INSTANCE = defaultInstance;
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      AddInboundRequest.class, defaultInstance);
  }
  ...
  private static volatile com.google.protobuf.Parser<AddInboundRequest> PARSER;

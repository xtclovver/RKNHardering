...
public  final class AlterOutboundResponse extends
    com.google.protobuf.GeneratedMessageLite<
        AlterOutboundResponse, AlterOutboundResponse.Builder> implements
  ...
  public static final class Builder extends
      com.google.protobuf.GeneratedMessageLite.Builder<
        com.xray.app.proxyman.command.AlterOutboundResponse, Builder> implements
  ...
  protected final java.lang.Object dynamicMethod(
    ...
    switch (method) {
      case NEW_MUTABLE_INSTANCE: {
        return new com.xray.app.proxyman.command.AlterOutboundResponse();
      }
      case NEW_BUILDER: {
        return new Builder();
      }
      ...
      case GET_PARSER: {
        com.google.protobuf.Parser<com.xray.app.proxyman.command.AlterOutboundResponse> parser = PARSER;
        if (parser == null) {
          synchronized (com.xray.app.proxyman.command.AlterOutboundResponse.class) {
            parser = PARSER;
            if (parser == null) {
              parser =
                  new DefaultInstanceBasedParser<com.xray.app.proxyman.command.AlterOutboundResponse>(
                      DEFAULT_INSTANCE);
              PARSER = parser;
            }
          }
  ...
  static {
    AlterOutboundResponse defaultInstance = new AlterOutboundResponse();
    // New instances are implicitly immutable so no need to make
    // immutable.
    DEFAULT_INSTANCE = defaultInstance;
    com.google.protobuf.GeneratedMessageLite.registerDefaultInstance(
      AlterOutboundResponse.class, defaultInstance);
  }
  ...
  private static volatile com.google.protobuf.Parser<AlterOutboundResponse> PARSER;
